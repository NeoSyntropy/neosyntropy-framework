...
from neosyntropy.utils.log import log_debug, log_error, log_info, log_warning
from neosyntropy.databases.vector.base import VectorDb
from neosyntropy.databases.vector.cassandra.index import neosyntropyMetadataVectorCassandraTable
...
class Cassandra(VectorDb):
    ...
    def initialize_table(self):
        self.table = NeoSyntropyMetadataVectorCassandraTable(
