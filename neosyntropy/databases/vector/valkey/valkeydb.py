...
from neosyntropy.filters import FilterExpr
from neosyntropy.knowledge.document import Document
from neosyntropy.knowledge.embedder import Embedder
...
from neosyntropy.utils.string import hash_string_sha256
...
class ValkeyDB(VectorDb):
    ...
    def __init__(
        ...
        client_name: str = "neosyntropy_vectordb_client",
    ...
    def _get_distance_metric(self) -> DistanceMetricType:
        """Map neosyntropy Distance to valkey-glide DistanceMetricType."""
        mapping = {
