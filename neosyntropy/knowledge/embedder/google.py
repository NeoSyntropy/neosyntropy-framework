...
from neosyntropy.utils.gemini import inject_neosyntropy_client_header
from neosyntropy.utils.log import log_error, log_info, log_warning
...
class GeminiEmbedder(Embedder):
    ...
    def client(self):
        ...
        _client_params = inject_neosyntropy_client_header(_client_params)
