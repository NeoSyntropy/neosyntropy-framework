...
class ChunkingStrategyFactory:
    ...
    def _create_agentic_chunking(
        ...
        from neosyntropy.knowledge.chunking.agentic import AgenticChunking
    ...
    def _create_code_chunking(
        ...
        from neosyntropy.knowledge.chunking.code import CodeChunking
    ...
    def _create_document_chunking(
        ...
        from neosyntropy.knowledge.chunking.document import DocumentChunking
    ...
    def _create_recursive_chunking(
        ...
        from neosyntropy.knowledge.chunking.recursive import RecursiveChunking
    ...
    def _create_semantic_chunking(
        ...
        from neosyntropy.knowledge.chunking.semantic import SemanticChunking
    ...
    def _create_row_chunking(
        ...
        from neosyntropy.knowledge.chunking.row import RowChunking
    ...
    def _create_markdown_chunking(
        ...
        from neosyntropy.knowledge.chunking.markdown import MarkdownChunking
