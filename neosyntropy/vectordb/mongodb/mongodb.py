...
from neosyntropy.utils.log import log_debug, log_error, log_info, log_warning, logger
...
DRIVER_METADATA = DriverInfo(name="NeoSyntropy", version=metadata.version("neosyntropy"))
