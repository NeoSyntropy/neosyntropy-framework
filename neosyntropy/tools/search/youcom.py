...
class YouTools(Toolkit):
    """
    YouTools exposes the You.com Search API as a first-class NeoSyntropy tool.
    ...
    no API key required). To use it instead, point NeoSyntropy's ``MCPTools`` at that URL.
