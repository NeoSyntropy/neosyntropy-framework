...
NeoSyntropy-style local toolkit: paths are resolved under a caller-provided
...
from neosyntropy.tools.core.registry import ToolRegistry, tool
...
class AstTools:
    """Register AST CI tools on a ToolRegistry (NeoSyntropy-style toolkit)."""
