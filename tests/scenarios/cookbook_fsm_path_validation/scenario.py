"""Scenario: Cookbook: FSM path validation.

Copy of ``cookbook/validation/fsm_path_validation_example.py`` for the scenario map. The graph is
...
SCENARIO_ID = "cookbook_fsm_path_validation"
SCENARIO_TITLE = "Cookbook: FSM path validation"
