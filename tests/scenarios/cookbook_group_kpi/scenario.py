"""Scenario: Cookbook: group KPI.

Copy of ``cookbook/kpi/group_kpi_example.py`` for the scenario map. The graph is
...
SCENARIO_ID = "cookbook_group_kpi"
SCENARIO_TITLE = "Cookbook: group KPI"
