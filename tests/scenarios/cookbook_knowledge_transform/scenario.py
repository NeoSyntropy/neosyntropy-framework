"""Scenario: Cookbook: FileSystemKnowledge transform.

Copy of ``cookbook/knowledge/transform_example.py`` for the scenario map. The graph is
...
```mermaid
flowchart LR
    FileSystemKnowledge --> transform --> summaries
```
"""

from tests.scenarios.cookbook_support import SPECS, build_from_spec

SCENARIO_ID = "cookbook_knowledge_transform"
SCENARIO_TITLE = "Cookbook: FileSystemKnowledge transform"
