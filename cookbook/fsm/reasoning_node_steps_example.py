...
from neosyntropy import Client, ReasoningStep, SchemaStep, ToolRegistry, tool, workflow
...
def main() -> None:
    ...
    def decide(params: DecisionSummary) -> str:
        return f"{params.decision}: {params.summary} -> {params.next_action}"
